...
import 'package:consumir/Jogo2/game/screens/components/popop_menu.dart';
import 'package:consumir/Jogo2/game/screens/initial_screen.dart';
import 'components/button_stop.dart';
import 'components/popop_menu.dart';
...
class _GamofLedState extends State<GamofLed> {
  Map<int, Led> list = {};
  String? labelButton; // Alteração feita aqui
  int index = 1;
  List<Timer> timer = [];
  int mili = 500;
  int level = 1;
  ...
  _GamofLedState() {
    list = initList();
    labelButton = null; // Adição feita aqui
  }
                ...
                child: Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      ButtonStop(label: labelButton!, stop: buttonStop), // Alteração feita aqui
                    ],
                  ),
                ),
              ),
